...
/**
 * Check the aswer asainst the first element in
 * the rereturned calculateCorrectAnwer array
 */
function checkAnswer() {
    ...
    if(isCorrect){
        alert("Hey! You got it rigt! :D");
        incrementScore();
    }else{
        alert(`Awwww... you answered ${userAnswer}. The correct amswer was ${calculatedAnswer[0]}!`);
...
/**
 * Gets the current tally or incorrect from the DOM and increments it by 1
 */
